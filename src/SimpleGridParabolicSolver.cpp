...
namespace ParabolicPDE{
    ...
    double SimpleGridParabolicSolver::setup(const String parameter_filename) {
    ...
    double SimpleGridParabolicSolver::assemble() {
        Timer timer;
        timer.start();
    ...
    double SimpleGridParabolicSolver::assemble_matrix() {
        Timer timer;
        timer.start();
    ...
    double SimpleGridParabolicSolver::assemble_rhs() {
        Timer timer;
        timer.start();
    ...
    double SimpleGridParabolicSolver::solve() {
        Timer timer;
        timer.start();
    ...
    void SimpleGridParabolicSolver::output() const {
    ...
    double SimpleGridParabolicSolver::compare_solution(
